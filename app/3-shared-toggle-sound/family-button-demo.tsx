...
export function MusicPlayerExample() {
  ...
  return (
    <div className="flex flex-col items-center pt-4">
      <div className="flex space-x-1 bg-neutral-700 shadow-inner-shadow px-[3px] py-[3.2px] border border-none rounded-[8px] cursor-pointer">
        {tabs.map((tab, i) => (
          <button
            key={`${tab.id}-i-${i}`}
          ...
          >
            {activeTab === tab.id && (
              <motion.span
                ...
                className="z-10 absolute inset-0 bg-neutral-800 shadow-inner-shadow mix-blend-difference"
